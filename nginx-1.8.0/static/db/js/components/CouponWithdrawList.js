require('../../less/coupon-withdraw-list.less');

var React = require('react');
var Navi = require('./Navi.js');
var browserHistory = require('react-router').browserHistory;
var CouponWithdrawListUtil = require('../utils/CouponWithdrawListUtil.js');
...
var WithdrawList = React.createClass({
	...
	componentDidMount: function() {
		...
		CouponWithdrawListUtil.getData(this.props.location.query,function(res){
			this.setState(res);
		}.bind(this));
	},

	componentWillReceiveProps: function(nextProps) {
		CouponWithdrawListUtil.getData(nextProps.location.query, function(res) {
			this.setState(res);
		}.bind(this));
	},
