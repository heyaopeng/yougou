...
var WithdrawUtil = require('../utils/WithdrawUtil.js');
...
var Withdraw = React.createClass({
	...
	componentDidMount: function() {
		WithdrawUtil.getData(function(res){
			this.setState(res);
		}.bind(this));
	},
	...
	render: function() {
		var bank = this.state.banks.map((item, index) => {
				...
				<div className='col-xs-12 trim-col'>
					<div className='withdraw'>
						...
						<form className='form-horizontal withdraw-form' onSubmit={this._handleSubmit}>
							...
							<div className='form-group withdraw-form-group'>
								<input className="form-control" type="number" name="money" placeholder={"最多可提现"+ this.state.account.commissionMoney +"元"}  onChange={this._handleChange.bind(this,'addrDetail')}/>
							</div>
							<div className="withdraw-info">
								温馨提示：每笔提现需收取2元手续费，每笔提现需大于20元
							</div>
	...
	_handleSubmit : function(e){
		...
		WithdrawUtil.withdrawHandle(data, function(res) {
