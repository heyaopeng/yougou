...
var ShowListUtil = require('../utils/ShowListUtil.js');
...
var ShowList = React.createClass({
	...
	componentDidMount: function() {
		...
		ShowListUtil.recordList(this.props.location.query, function(res) {
			this.setState({
	...
	componentWillReceiveProps: function(nextProps) {
		ShowListUtil.recordList(nextProps.location.query, function(res) {
			this.setState({
				hasNextPage: res.hasNextPage,
				userShowList: res.userShowList,
				pageNum: res.pageNum
	...
	_loadMore: function() {
		if (this.state.hasNextPage) {
            ...
            ShowListUtil.recordList(q, function(res) {
