require('../../less/coupon-detail.less');
var React = require('react');
var request = require('superagent');
var Navi = require('./Navi.js');
var CouponDetailUtil = require('../utils/CouponDetailUtil.js');
...
var CashCoupon = React.createClass({
	...
	componentDidMount: function() {
		CouponDetailUtil.getData(this.props.location.query,function(res) {
			...
			<div className='row'>
				<div className='col-xs-12 trim-col'>
					<div className='cash-coupon'>
						...
						<div className='cash-coupon-qrcode'><img src={this.state.url} className='cash-coupon-qrcode-img'/></div>
						<div className='cash-coupon-text'>请持此二维码到合作商家处兑换</div>
						<Navi />
					</div>
				</div>
			</div>
	...
	_clickHandler : function(){
		...
		CouponDetailUtil.submit(data,function(res){
