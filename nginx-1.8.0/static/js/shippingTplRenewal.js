        ...
        if($this.data('formValidation').isValid()){
            ...
            if($tbody.find('.js-append-tr').length>0){   
                $tbody.find('.js-append-tr').each(function(idx,ele){
                    ...
                    $ele.find('.f-day').attr('name','chargeRenewals[\''+(idx*1+1)+'\'].deliverTime');
                    $ele.find('.f-first-piece').attr('name','chargeRenewals[\''+(idx*1+1)+'\'].first');
                    $ele.find('.f-first-price').attr('name','chargeRenewals[\''+(idx*1+1)+'\'].firstPrice');
                    $ele.find('.f-piece').attr('name','chargeRenewals[\''+(idx*1+1)+'\'].addition');
                    $ele.find('.f-price').attr('name','chargeRenewals[\''+(idx*1+1)+'\'].additionPrice');
                    $ele.find('.js-address-hidden').attr('name','chargeRenewals[\''+(idx*1+1)+'\'].destination');
                }); 
            }
             $this[0].submit();
        }
