...
require('../less/help-sidebar.less');

module.exports = (function() {
    var moduleName = 'helpSidebar';
    ...
    return {
        init: function() {
            ...
            module.on('click', '[data-toggle="submenu"]', function(e) {
                ...
                if ($li.is('.active')) {
                    $li.find('.help-sidebar-submenu').slideUp('fast', function () {
                    ...
                    if ($prevActiveLi.length) {
                        $prevActiveLi.find('.help-sidebar-submenu').slideUp('fast',function () {
                            $prevActiveLi.removeClass('active');
                            $(this).removeAttr('style');
                        });
                    }

                    $li.find('.help-sidebar-submenu').stop().slideDown('fast',function() {
                        $li.addClass('active');
                    });
                }
            });
